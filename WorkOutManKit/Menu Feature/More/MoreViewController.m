...
@interface MoreViewController ()<MFMailComposeViewControllerDelegate,SKStoreProductViewControllerDelegate>
{
    NSArray *resultArray;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        if (indexPath.row == 0){
            BookmarkViewController *bk = [[BookmarkViewController alloc] init];
