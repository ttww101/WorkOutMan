...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"健身减肥助手";
...
- (void)setContainerViewController {
    WorkOutManVC *vc1 = [WorkOutManVC new];
...
- (UIColor *)tabBarColor {
    return [UIColor colorWithRed:0.0/255.0 green:75.0/255.0 blue:84.0/255.0 alpha:1.0];
}
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    if(section == 0){
        ...
        UIColor *bgColor = [UIColor colorWithPatternImage: [UIImage imageNamed:@"fitnessbg"]];
